...
<title>$wkn::define::index_title</title>
  ...
  <frameset rows = "60,*">
    ...
    <frameset cols = "25%,*">
        <frameset rows = "*, 50">
          <frame src="wkn_js.cgi?target=body&$notes_path" name="menu" marginwidth="0" marginheight="0">
          <frame src="$this_script?frame=footer&$notes_path" name="footer" marginwidth="0"
                 marginheight="0" scrolling="no">
        </frameset>
      <frame src="wkn_$mode.cgi?$notes_path" name="body" marginwidth="0" marginheight=
"0">
    </frameset>
  </frameset>
</html>
