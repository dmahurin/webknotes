...
local($main_dir) = "/home/d/m/dmahurin/web";
...
local($ftp_wpath) = "ftp://ftp.one.net/pub/users/dmahurin/files";
$wpath_prefix_translation{"$public_wpath/files"} = $ftp_wpath;
...
[ <a href=\"${ftp_wpath}\">  File Area Index</a>]";
