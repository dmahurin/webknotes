...
sub show_page
{
   ...
   my $frame = &view::get_view_mode("frame");
   ...
   &view::set_view_mode("superlayout", "js");
   &view::set_view_mode("target", "body");
   my ($js_script_prefix, $js_bsuffix) = view::get_cgi_prefix();
...
print <<"EOT";
    <frameset cols = "25%,*">
        <frameset rows = "*, 50">
          <frame src="${js_script_prefix}$notes_path_encoded$js_bsuffix" name="menu" marginwidth="0" marginheight="0">
